        ...
        return (
          r(e, [
            { key: "_init", value: function() {} },
            {
              ...
              value: function() {
                var e = this;
                this.slider.container.addEventListener("dragstart", function(
                  t
                ) {
            ...
            },
            {
              ...
              value: function() {
                var e = this;
                this.slider.container.removeEventListener("dragstart", function(
                  t
                ) {
                  e._supportsPassive || t.preventDefault();
                }),
                ...
                return (
                  "fade" === this.options.effect &&
                    this.slider.slides.forEach(function(t, e) {
                      Object(
                        s.a
                      )(t, { position: "absolute", left: 0, top: 0, bottom: 0, "z-index": t.dataset.sliderIndex == i.slider.state.index ? 0 : -2, opacity: t.dataset.sliderIndex == i.slider.state.index ? 1 : 0 });
                    }),
                  this
                );
              }
